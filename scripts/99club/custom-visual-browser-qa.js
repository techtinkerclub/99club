...
(async function(){
  ...
  try{
    const G=window.TT99Generator,L=window.TT99PDFLayout,W=window.TT99CustomWrittenMethods,R=window.TT99CustomReasoning;
    if(!G||!L||!W||!R){fail('load','Required generator/layout/expansion modules missing');finish();return;}
