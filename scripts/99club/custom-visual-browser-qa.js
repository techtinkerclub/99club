...
(async function(){
  ...
  try{
    const G=window.TT99Generator,L=window.TT99PDFLayout,W=window.TT99CustomWrittenMethods,R=window.TT99CustomReasoning,S=window.TT99CustomStructured,F=window.TT99CustomVisualReasoning,A=window.TT99CustomAppliedVisuals,E=window.TT99CustomExtraVisuals;
    if(!G||!L||!W||!R||!S||!F||!A||!E){fail('load','Required generator/layout/expansion modules missing');finish();return;}
