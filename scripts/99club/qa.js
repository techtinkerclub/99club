...
try{
  ...
  ok('goodies-fractions','Fraction Wall keeps its existing maths and adds draggable, partitionable, equivalent-aware strips plus shared Standard/Custom challenges');
