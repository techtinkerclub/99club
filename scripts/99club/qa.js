...
try{
  ...
  for(const token of ['gd-fr-mode-tabs','fw-strip-canvas','function stripMarkup','function mountWorkbench',"I.toolButton('split'","I.toolButton('simplify'","I.toolButton('align'",'data-fr-strip-piece','function alignStrips','function switchMode',"{id:'identify-strip'","{id:'equivalent-strip'","{id:'compare-strips'","{id:'simplify-strip'","{id:'mixed-improper'","{id:'denominator-misconception'",'function challengeControlsHtml','function generateChallenge','function customAnswerSources','function resolveCustomAnswerSource','data-fw-workflow','fw-custom-answer-source','function bindChallengeStageActions','CK.pickerHtml','CK.bannerHtml','function exportControlsHtml','function wallExportSvg','function stripsExportSvg','function fractionExportSvg','data-fw-export','data-fw-export-mode','fw-copy-image','fw-svg-download','fw-response-lines'])if(!goodiesToolsA.includes(token))fail('goodies-fractions','Fraction direct-workbench/challenge contract missing: '+token);
