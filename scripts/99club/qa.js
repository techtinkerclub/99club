...
try{
  ...
  if(!playPage.includes('games-play-icons-v1.js?v=1')||!playPage.includes('games-play-icons-v1.css?v=1'))fail('game-icons','coherent game icon assets are not both loaded by /play/');
  ...
  ok('game-icons','All 40 Online Play games have coherent shared SVG icons');
