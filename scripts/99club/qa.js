...
try{
  ...
  ok('goodies-arrays','Arrays supports direct row/column resizing, factor rotation, partitions, repeated addition, inverse division facts, partial products and shared Standard/Custom challenges');
