...
try{
  ...
  for(const token of ["{id:'read-mark'","{id:'place-mark'","{id:'distance-between'","{id:'cm-to-mm'","{id:'mm-to-cm'","{id:'cm-to-m'","{id:'unit-misconception'",'function customAnswerSources','function liveAnswer','function markerFrozen','function generateChallenge','data-me-workflow','me-custom-answer-source','function bindRuler','function bindChallengeStageActions','CK.pickerHtml','CK.bannerHtml','secondaryCm'])if(!goodiesToolsB.includes(token))fail('goodies-measurement','Measurement shared challenge contract missing: '+token);
  ...
  ok('goodies-measurement','Measurement ruler supports direct touch/keyboard placement, live conversions and shared Standard/Custom challenges');
