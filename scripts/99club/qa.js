...
try{
  ...
  for(const token of ["{id:'read-coordinate'","{id:'plot-coordinate'","{id:'missing-coordinate'","{id:'reflect-axis'","{id:'translate-point'","{id:'identify-quadrant'",'function customAnswerSources','function resolveCustomAnswerSource','function challengeFrozen','function generateChallenge','data-co-workflow','co-custom-answer-source','function bindChallengeStageActions','CK.pickerHtml','CK.bannerHtml','hiddenPointLabels','pointLabelOverrides','fourQuadrants'])if(!goodiesToolsB.includes(token))fail('goodies-coordinates','Coordinates shared challenge contract missing: '+token);
  ok('goodies-coordinates','Coordinates keeps direct point dragging and persistent quadrant switching while adding pupil-safe Standard/Custom challenges');
