...
try{
  ...
  for(const token of ['gd-fr-mode-tabs','fw-strip-canvas','function stripMarkup','function mountWorkbench',"I.toolButton('split'","I.toolButton('simplify'","I.toolButton('align'",'data-fr-strip-piece','function alignStrips','function switchMode'])if(!goodiesToolsA.includes(token))fail('goodies-fractions','Fraction direct-workbench contract missing: '+token);
  ...
  ok('goodies-fractions','Fraction Wall keeps its existing maths and adds draggable, partitionable, equivalent-aware fraction strips');
