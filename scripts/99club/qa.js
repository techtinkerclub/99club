...
try{
  ...
  for(const token of ['function arrayBuilder','function partitionMath','data-ab-resize="cols"','data-ab-resize="rows"','data-ab-row-split','data-ab-col-split','data-ab-partial','Rotate / swap factors','Repeated addition','Related division facts','Partial products'])if(!goodiesToolsA.includes(token))fail('goodies-arrays','Array direct-manipulation workbench missing: '+token);
  ...
  ok('goodies-arrays','Arrays supports direct row/column resizing, factor rotation, partitions, repeated addition, inverse division facts and partial products');
