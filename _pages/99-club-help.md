...
<div class="tt99-guide">
  ...
  <section id="schemes" class="tt99-guide-section">
    ...
    <div class="tt99-guide-table-wrap"><table class="tt99-guide-table">
      <thead><tr><th>Challenge</th><th>Default content</th></tr></thead><tbody>
        <tr><td>11 Club</td><td>Doubling</td></tr>
        <tr><td>22 Club</td><td>Repeated addition</td></tr>
        <tr><td>33–66 Club</td><td>Progressively broader multiplication-table fluency</td></tr>
        <tr><td>77 Club</td><td>Division / inverse facts</td></tr>
        <tr><td>88–99 Club</td><td>Mixed multiplication and division</td></tr>
      </tbody>
    </table></div>

    <h3>Post-99 challenges</h3>
    <div class="tt99-guide-table-wrap"><table class="tt99-guide-table">
      <thead><tr><th>Challenge</th><th>Core content</th></tr></thead><tbody>
        <tr><td>Bronze</td><td>Multiplication and exact division using all 1–12 tables</td></tr>
    ...
    <h3>Alternative 11–99 schemes</h3>
    <p>The scheme menu also includes Addition-first, Arithmetic-first, Missing-number progression and Tables-first presets. Each scheme keeps its own edits, so experimenting with one does not change your Classic rules.</p>
  </section>
