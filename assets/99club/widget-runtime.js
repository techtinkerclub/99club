...
root.innerHTML='<section class="ttw-shell ttw-shell--'+esc(cfg.widgetType)+'" aria-label="'+esc(title)+'">'+
  '<div class="ttw-head"><img class="ttw-school-logo" src="'+esc(logo)+'" alt=""><div><h1>'+esc(schoolName||title)+'</h1><p>'+esc(schoolName?title:title==='Maths home practice'?'School-selected practice':'School-selected '+title.toLowerCase())+'</p></div></div>'+
