...
const clubHtml=cfg.selectedClubs.map(id=>{
  ...
  return '<a class="ttw-club" href="'+esc(href)+'" target="_blank" rel="noopener noreferrer"><img src="/assets/99club/images/'+esc(img)+'" alt=""><strong>'+esc(names[id]||id)+'</strong><small>Fresh worksheet + answers</small></a>';
}).join('');
