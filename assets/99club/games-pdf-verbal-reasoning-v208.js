...
function rect(c,x,y,w,h,opt){opt=opt||{};var py=PH-y-h,fill=opt.fill||WHITE,stroke=opt.stroke||LINE,width=opt.width==null?0.8:opt.width;c.push(rgb(fill)+' rg '+rgb(stroke)+' RG '+n(width)+' w '+n(x)+' '+n(py)+' '+n(w)+' '+n(h)+' re B');}
