...
function puzzlesCard(){
  ...
  }).join(''):'<div class="tt99-wb-empty">No printable puzzle packs yet. Configure one in Maths Games &amp; Puzzles, open its sharing window and choose <b>Add current pack to widget</b>.</div>';
